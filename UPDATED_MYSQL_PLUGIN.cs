...
// Using the newer MySqlConnector instead of legacy MySQL.Data
...
namespace pGina.Plugin.MySQLAuth
{
    class MySqlUserDataSource : IDisposable
    {
        ...
        public MySqlUserDataSource()
        {
            ...
            // MySQL 8 and MariaDB compatibility settings
            builder.SslMode = Settings.Store.UseSsl ? MySqlSslMode.Required : MySqlSslMode.None;
            
            // Handle MySQL 8 authentication method
            builder.AllowUserVariables = true;
            builder.AllowZeroDateTime = true;
            builder.ConvertZeroDateTime = true;
            
            // Set connection timeout and other parameters for better compatibility
            ...
            {
                m_conn.Open();
                m_logger.DebugFormat("Successfully connected to database.");
            }
            else 
            {
